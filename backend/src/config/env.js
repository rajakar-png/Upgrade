...
const envSchema = z.object({
  ...
  BACKUP_CRON_CONCURRENCY: z.string().default("3"),
  AUDIT_LOG_RETENTION_DAYS: z.string().default("90"),
  IDEMPOTENCY_RETENTION_DAYS: z.string().default("7"),
...
export const env = {
  ...
  BACKUP_CRON_CONCURRENCY: Number(parsed.data.BACKUP_CRON_CONCURRENCY),
  AUDIT_LOG_RETENTION_DAYS: Number(parsed.data.AUDIT_LOG_RETENTION_DAYS),
  IDEMPOTENCY_RETENTION_DAYS: Number(parsed.data.IDEMPOTENCY_RETENTION_DAYS),
