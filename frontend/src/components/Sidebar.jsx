...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden w-64 flex-col gap-6 border-r border-dark-700/50 bg-dark-900/80 px-5 py-6 backdrop-blur-xl lg:flex">
      <Logo size="lg" />
      ...
      <div className="space-y-3">
        {isAdmin && (
          <div className="rounded-xl border border-primary-500/20 bg-primary-500/5 p-4 transition-all hover:border-primary-500/30 hover:bg-primary-500/10">
            <NavLink
              to="/admin"
              className="flex items-center gap-2 text-sm font-semibold text-white transition-colors hover:text-primary-300"
            >
