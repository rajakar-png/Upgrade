        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white md:text-4xl">
              Earn Coins While{' '}
              <span className="text-gradient">You Stay Online</span>
            </h2>

            <p className="mt-4 text-gray-400">
              AstraNodes rewards active users with coins that can be redeemed for free server hosting time.
              The more you engage, the more you save.
            </p>
            ...
            {rewards.map((r) => (
              ...
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#ff7a18]/10 transition-colors group-hover:bg-[#ff7a18]/20">
                  <r.icon className="h-6 w-6 text-[#ff7a18]" />
                </div>
