    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          type="button"
          className="button-3d group w-full h-12 rounded-xl bg-[#5865F2] text-white font-semibold text-sm flex items-center justify-center gap-3 hover:bg-[#4752C4] transition-all border border-[#5865F2]/30 shadow-lg shadow-[#5865F2]/15"
        >
